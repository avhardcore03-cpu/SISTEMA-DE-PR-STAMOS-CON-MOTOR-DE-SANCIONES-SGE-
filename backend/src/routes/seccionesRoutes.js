...
router.get('/usuarios', (req, res) => {
    try {
        ...
        const estudiantesPrueba = [
            { id: 1, nombre: "Juan Pérez", email: "juan@test.com", rol: "ESTUDIANTE" },
            { id: 2, nombre: "María Gómez", email: "maria@test.com", rol: "ESTUDIANTE" },
            { id: 3, nombre: "Carlos López", email: "carlos@test.com", rol: "ESTUDIANTE" }
        ];
